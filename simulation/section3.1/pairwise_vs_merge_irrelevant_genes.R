...
MSE1.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                  XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 1)
save(MSE1.noise, file = "MSE1171_noise.RData")

MSE2.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 2)
save(MSE2.noise, file = "MSE1172_noise.RData")

MSE3.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 3)
save(MSE3.noise, file = "MSE1173_noise.RData")

MSE4.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 4)
save(MSE4.noise, file = "MSE1174_noise.RData")

MSE5.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 5)
save(MSE5.noise, file = "MSE1175_noise.RData")

MSE6.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 6)
save(MSE6.noise, file = "MSE1176_noise.RData")

MSE7.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 7)
save(MSE7.noise, file = "MSE1177_noise.RData")

MSE8.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 8)
save(MSE8.noise, file = "MSE1178_noise.RData")

MSE9.noise <-  multiple(size=500, numx=5, numxs=5, numnoise = 10, XY="Medium", 
                        XSY="Medium", corr="1-2", xxs.non.miss.num= 7, noise.non.miss.num = 9)
save(MSE9.noise, file = "MSE1179_noise.RData")
